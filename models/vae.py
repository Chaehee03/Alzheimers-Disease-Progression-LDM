...
class VAE(nn.Module):
    def __init__(self, im_channels, model_config):
        ...
        # To disable attention in Downblock of Encoder and Upblock od Decoder
        ...
        # corresponds to downsampling in encoder
        self.up_sample = list(reversed(self.down_sample))

        ################## Encoder ##################
        self.encoder_conv_in = nn.Conv3d(im_channels, self.down_channels[0], kernel_size=3, stride=1, padding=1)
        ...
        # Latent Dimension: 2*Latent -> each for predicting mean & variance
        ...
        self.decoder_conv_in = nn.Conv3d(self.z_channels, self.mid_channels[-1], kernel_size=3, stride=1, padding=1)
        ...
        for i in reversed(range(1, len(self.down_channels))):
            ...
            self.decoder_conv_out = nn.Conv3d(self.down_channels[0], im_channels, kernel_size=3, stride=1, padding=1)
